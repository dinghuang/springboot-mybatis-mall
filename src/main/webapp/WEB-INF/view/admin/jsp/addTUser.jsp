										...
										<table width="100%" border="0" cellpadding="0" cellspacing="5"
											...
											<tr>
												<td>&nbsp;<a href="<%=path%>/admin/jsp/adminright.jsp"
													...
													class="font1">${trights==2? '注册用户管理':'系统用户管理'}</a>
													&gt;<a class="font1"><strong> 添加账户</strong></a></td>
											</tr>
										</table>
									</td>
								</tr>
							...
							<form action="<%=path%>/tUserServletUrl?task=addSubmit"
								...
								<table width="85%" border="0" cellspacing="0" align="center">
									...
									<tr>
										...
										<td><input type="radio" name="tsex" value="男" checked />男&nbsp;&nbsp;<input
											type="radio" name="tsex" value="女" />女 <span id="tsexSpan"></span></td>
									</tr>
									...
									<tr>
										...
										<td><input type="radio" name="trights" value="2" ${trights==2? 'checked':''} />普通用户&nbsp;&nbsp;
											<input type="radio" name="trights" value="1" ${trights==2? '':'checked'}/>系统管理员<span
