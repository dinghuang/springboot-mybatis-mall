		...
		<tr>
			...
			<td bgcolor="#FFFFFF" style="height:490px; vertical-align:top;">
				<table width="100%" border="0" cellspacing="10" cellpadding="0">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="5"
											...
											<tr>
												<td>&nbsp;<a href="<%=path%>/admin/jsp/adminright.jsp"
													...
													class="font1"><strong>商品大类管理</strong></a></td>
											</tr>
										</table>
									</td>
								</tr>
						...
						<td>
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
								<tr>
									<td>
										<center>
											<form action="<%=path%>/bigMcServletUrl" method="post"
												name="selectForm">
												类别编号:<input type="text" name="bid" value="${bid}"
													class="text" /> 类别名:<input type="text" name="bname"
													value="${bname}" class="text" /> <input type="submit"
									...
									<td>
										<table width="100%" border="0" cellpadding="0" cellspacing="1"
											...
											<tr height="27px">
												...
												<th background="<%=path%>/admin/jsp/images/index1_72.gif">商品大类编号</th>
												<th background="<%=path%>/admin/jsp/images/index1_72.gif">商品大类名</th>

											</tr>
											<c:forEach items="${list}" var="bigMcBean" varStatus="vs">
												<tr bgcolor="${vs.count%2==0?'#F7FAFF':''}">
													<td align="center"><input type="radio" name="bid"
														value=${ bigMcBean.bid} /></td>
													<td align="center">${bigMcBean.bid}</td>
													<td align="center">${bigMcBean.bname}</td>
					...
					<tr>
						<td><a href="<%=path%>/bigMcServletUrl?task=add"> <img
								src="<%=path%>/admin/jsp/images/index1_86.gif" width="74"
								height="31" border="0" /></a>&nbsp; <a
							href="javascript:subMitData('<%=path%>/bigMcServletUrl?task=update')">
								<img src="<%=path%>/admin/jsp/images/index1_82.gif" width="74"
								height="31" border="0" />
						</a>&nbsp; <a
							href="javascript:subMitData('<%=path%>/bigMcServletUrl?task=delete')">
