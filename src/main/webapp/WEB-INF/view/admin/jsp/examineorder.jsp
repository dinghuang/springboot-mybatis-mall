		...
		<tr>
			...
			<td bgcolor="#FFFFFF" style="height:490px; vertical-align:top;">
				<table width="100%" border="0" cellspacing="10" cellpadding="0">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="5"
											...
											<tr>
												<td>&nbsp;<a href="<%=path%>/admin/jsp/adminright.jsp"
													...
													<a class="font1"><strong>订单审核</strong></a></td>
											</tr>
										</table>
									</td>
								</tr>
						...
						<td>
							<table width="100%" border="0" cellpadding="0" cellspacing="1">
								<tr>
									<td>
										<center>
											<form action="<%=path%>/orderServletUrl?ostatus=0"
												method="post" name="selectForm">
												订单编号:<input type="text" name="oid" value="${oid}"
													class="text" style="width: 200px" /> 用户名:<input type="text"
													name="tuser" value="${tuser}" class="text" /> 订单日期:<input
													type="text" name="oorderdate" value="${oorderdate}"
					...
					<tr>
						<td><a
							href="javascript:subMitData('<%=path%>/orderServletUrl?task=examine')">
								<input type="button" value="审核订单" style="cursor: pointer;"/>
						</a></td>
					</tr>
				</table>
