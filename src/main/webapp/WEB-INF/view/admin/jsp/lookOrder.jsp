				...
				<table width="100%" border="0" cellspacing="10" cellpadding="0">
							...
							<table width="85%" border="0" cellspacing="0" align="center"
								...
								<tr>
									...
									<td rowspan="2"><textarea cols="20" rows="10"
											style="width:180px;height: 80px" readonly="readonly">${tOrderBean.omsg}</textarea></td>
					...
					<tr>
						<td colspan="2" align="center"><a
							href="javascript:history.back(0);"><input type="button"
												value="返回" style="height=28px;width=64px;" /></a></td>
