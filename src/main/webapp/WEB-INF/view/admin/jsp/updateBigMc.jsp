...
<script language="javascript">
	function checkBname() {
		var bname = bigMcForm.bname;
		var span = document.getElementById("bnameSpan");
		if (bname.value == '') {
			bname.focus();
			span.innerHTML = "&nbsp;*名称必填";
			return false;
		...
		<tr>
			...
			<td bgcolor="#FFFFFF" style="height:490px; vertical-align:top;">
				<table width="100%" border="0" cellspacing="10" cellpadding="0">
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="5"
											...
											<tr>
												<td>&nbsp;<a href="<%=path%>/admin/jsp/adminright.jsp"
													...
													&gt; <a href="<%=path%>/bigMcServletUrl" class="font1">商品大类管理</a>
													&gt;<a class="font1"><strong> 修改大类</strong></a></td>
											</tr>
										</table>
									</td>
								</tr>
					...
					<tr>
						<td>
							<form action="<%=path%>/bigMcServletUrl?task=updateSubmit"
								method="post" onSubmit="return checkForm()" name="bigMcForm">
								<table width="85%" border="0" cellspacing="0" align="center"
									style="font-size:20px">
									<tr>
										<td width="40%" align="right">商品大类编号：</td>
										<td width="60%"><input type="text" name="bid"
											style="width:180px" value="${bigMcBean.bid }"
											readonly="readonly" /></td>
									</tr>
									<tr>
										<td align="right">商品大类名称：</td>
										<td><input type="text" name="bname" style="width:180px"
											value="${bigMcBean.bname}" /> <span id="bnameSpan"></span></td>
									</tr>
									<tr>
