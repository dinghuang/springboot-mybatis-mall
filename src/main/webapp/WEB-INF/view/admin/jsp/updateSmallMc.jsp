										...
										<table width="100%" border="0" cellpadding="0" cellspacing="5"
											...
											<tr>
												<td>&nbsp;<a href="<%=path%>/admin/jsp/adminright.jsp"
													...
													href="<%=path%>/smallMcServletUrl" class="font1">商品小类管理</a>
													&gt;<a class="font1"><strong> 修改小类</strong></a></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<table width="85%" border="0" cellspacing="0" align="center"
									...
									<tr>
										...
										<td><input type="text" name="sname" style="width:180px"
											value="${smallMcBean.sname}" /> <span id="snameSpan"></span></td>
									</tr>
									<tr>
										<td align="right">所属父类名称：</td>
										<td><select style="width:180px" name="bid">
												...
												<c:forEach items="${bigMcList}" var="bigMcBean"
													...
													<option value="${bigMcBean.bid}"
														${smallMcBean.bid==bigMcBean.bid?'selected="selected"':''}>${bigMcBean.bname }</option>
												</c:forEach>
